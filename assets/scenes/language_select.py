...
def loader(scene):
    ...
    #buttons
    english_btn = u.Button(name="btn.lang.english", scale=(.175,.128), position=(0,0.075,-1), icon="english_flag", parent=u.camera.ui, on_click=lambda:select_language("English"))
    german_btn = u.Button(name="btn.lang.german", scale=(.175,.128), position=(0,-0.075,-1), icon="german_flag", parent=u.camera.ui, on_click=lambda:select_language("German"))
