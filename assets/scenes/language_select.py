...
def loader(scene):
    return [
        ...
        #buttons
        language_flag(
            name="btn.lang.english", text="English", scale=(.175,.128), position=(0,0.075,-1), 
            texture="english_flag", parent=u.camera.ui, onclick=(lambda:select_language("English"), None)
        ),
        language_flag(
            name="btn.lang.german", text="German", scale=(.175,.128), position=(0,-0.075,-1), 
            texture="german_flag", parent=u.camera.ui, onclick=(lambda:select_language("German"), None)
        )
    ]
